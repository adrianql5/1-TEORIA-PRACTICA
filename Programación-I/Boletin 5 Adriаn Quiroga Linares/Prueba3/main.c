...
#include <stdio.h>
#include <stdlib.h>
//EN ESTA PRUEBA INTROUZCO UNA FECHA MAL PARA QUE ME SALTE UN AVISO DE QUE ESTA FUERA DEL RANGO DEL ARCHIVO
...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i < cantidad_archivos; i++) {
        ...
        Data fechaInicio = {31, 12, 201120};
        Data fechaFin = {1, 1, 20};
